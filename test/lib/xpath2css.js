...
// Ported by Dither from [xpath2css](https://github.com/santiycr/xpath2css)
...
function xpath2css(xpath) {
    ...
    while(xpatharr[xindex]) {
        ...
        while(nodes = prog.exec(xpatharr[xindex])) {
            ...
            // console.log('broke node down to: ' + JSON.stringify(match));
            ...
            // console.log('final node css: ' + node_css);
            css.push(node_css);
            position++;
        } //while(nodes
